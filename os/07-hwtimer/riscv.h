...
#define MIE_MEIE (1 << 11) // external  外部Machine-mode Interrupt 开启状态
#define MIE_MTIE (1 << 7)  // timer     计时器Machine-mode Interrupt 开启状态
#define MIE_MSIE (1 << 3)  // software  软件Machine-mode Interrupt 开启状态
